...
import cn.wanghw.utils.ChineseNameValidator;
        ...
        for (String str : allStrings) {
            ...
            while (matcher.find()) {
                ...
                if (extracted != null && !extracted.isEmpty()) {
                    ...
                    // 如果是中文姓名，进行姓名验证
                    if (rule.getName().contains("Chinese Name") || rule.getName().contains("中文姓名")) {
                        if (!ChineseNameValidator.isValidName(extracted)) {
                            continue;
                        }
                    }
